...
public class TimeAndDate_CapturingFirstColaumDataMethod2 {
	...
	*/
		String ExpathExpresionpart1="/html/body/div[5]/section[1]/div/section/div[1]/div/table/tbody/tr[1";
		String ExpathExpresionpart2="]/td[1]";
		for(int index=1;index<=36;index++)
		{
			By ExpathLocatorLocator=By.xpath(ExpathExpresionpart1+index+ExpathExpresionpart2);
			WebElement CityName=driver.findElement(ExpathLocatorLocator);
